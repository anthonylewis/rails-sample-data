...
class CarMakesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get index" do
    get car_makes_url, as: :json
    assert_response :success
  end

  test "should create car_make" do
    assert_difference('CarMake.count') do
      post car_makes_url, params: { car_make: { name: @car_make.name } }, as: :json
    end
  ...
  test "should show car_make" do
    get car_make_url(@car_make), as: :json
    assert_response :success
  end

  test "should update car_make" do
    patch car_make_url(@car_make), params: { car_make: { name: @car_make.name } }, as: :json
    assert_response 200
  end

  test "should destroy car_make" do
    assert_difference('CarMake.count', -1) do
      delete car_make_url(@car_make), as: :json
    end
